...
class EllpackMat {
public:
    EllpackMat(const std::string &matrixFile, const std::string &vectorFile);
    std::vector<double> PerformMultiplicationDouble();

private:
    void buildEllpackMatrix(const Triplets &triplets, index_t m, index_t n);
...
EllpackMat::EllpackMat(const std::string &matrixFile, const std::string &vectorFile) {
    // Read matrix
    Triplets triplets;
    ...
    buildEllpackMatrix(triplets, m, n);
...
std::vector<double> EllpackMat::PerformMultiplicationDouble() {
...
void EllpackMat::buildEllpackMatrix(const Triplets &triplets, index_t m, index_t n) {
...
int main() {
    ...
    EllpackMat ellMatrix(matrixFile, vectorFile);
